...
$answer = $client->subscribe({list_ids=>[@available_list_ids], fields=> {email=>'sam@parson.com', phone=>'1 234 5678900', twitter=>'sammy', name=>'Василий Пупкин'}});
$result = $answer->{result};
is ($answer->{error}, undef, 'shoudnt have errors');
...
$answer = $client->unsubscribe({contact_type=>'phone', contact=>'+1 111 1111111'});
is ($answer->{error}, undef, 'shoudnt have errors');
